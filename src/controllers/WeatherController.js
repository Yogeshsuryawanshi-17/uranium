...
const getwWeather = async function (req, res) {

    //http://api.openweathermap.org/data/2.5/weather?q=Pune&appid=4c99ee5ad5f5da8285e186fd4cbf7d4c
...
try{
    ...
    for (let i = 0; i < cities.length; i++) {
        ...
        first.temp = result.data.main.temp
        tempcityarray.push(first)
    }

    let sorttempcityarray = tempcityarray.sort( function(a,b){return a.temp -  b.temp}  )
...
module.exports.getwWeather = getwWeather
